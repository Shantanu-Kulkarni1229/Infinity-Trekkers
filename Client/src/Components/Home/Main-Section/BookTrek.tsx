...
const BookTrek = () => {
      ...
      <div className="min-h-screen bg-white flex items-center justify-center">
        <div className="text-center">
          <div className="relative">
            ...
            <div className="absolute inset-0 w-12 h-12 border-2 border-transparent border-t-sky-400 rounded-full animate-spin mx-auto mt-2 ml-2"></div>
          </div>
          <h3 className="text-xl font-semibold text-gray-800 mb-2">Loading Trek Details</h3>
    ...
    return (
      <div className="min-h-screen bg-white flex items-center justify-center">
        <div className="text-center max-w-md mx-auto p-8">
          ...
          <h3 className="text-xl font-semibold text-gray-800 mb-2">Unable to Load Trek</h3>
          <p className="text-red-600 mb-6">{error}</p>
          <button 
            onClick={() => window.location.reload()} 
            className="bg-sky-600 text-white px-6 py-3 rounded-full hover:bg-sky-700 transform hover:scale-105 transition-all duration-200 shadow-lg hover:shadow-xl"
          >
            Try Again
          </button>
        </div>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-sky-50 via-white to-sky-50">
      ...
      {/* Header Section */}
     {/* Header Section */}
<div className="bg-gradient-to-r from-sky-600 via-sky-700 to-sky-800 text-white py-12 relative overflow-hidden">
  <div className="absolute inset-0 bg-gradient-to-r from-sky-600 via-sky-700 to-sky-800 bg-opacity-10"></div>
  <div className="absolute top-0 left-0 w-full h-full">
    <div className="absolute top-6 left-10 w-16 h-16 bg-white bg-opacity-10 rounded-full animate-pulse"></div>
    <div className="absolute top-20 right-20 w-12 h-12 bg-white bg-opacity-5 rounded-full animate-pulse" style={{animationDelay: '1s'}}></div>
    <div className="absolute bottom-10 left-1/4 w-8 h-8 bg-white bg-opacity-10 rounded-full animate-pulse" style={{animationDelay: '2s'}}></div>
  </div>
  <div className="container mx-auto px-6 relative z-10">
    <div className="text-center">
      <h1 className="text-4xl md:text-5xl font-bold mb-2 bg-gradient-to-r from-white to-sky-100 bg-clip-text text-transparent">
        Book Your Adventure
      </h1>
      <p 
        ...
        <div className="max-w-4xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="bg-white rounded-3xl shadow-xl p-8 border border-gray-100 relative overflow-hidden">
              <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-bl from-sky-100 to-transparent rounded-full -translate-y-16 translate-x-16"></div>
              ...
              <div className="relative z-10">
                <div className="flex items-center mb-6">
                  ...
                  <h2 className="text-2xl font-bold text-gray-800">Trek Details</h2>
                </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center text-gray-600">
                    <svg className="w-5 h-5 mr-3 text-sky-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                    </svg>
                    <span className="font-semibold">{stripHtmlTags(trek.name)}</span>
                  </div>
                  ...
                  <div className="flex items-center text-gray-600">
                    ...
                    <span>
                      <strong>Start:</strong> {new Date(trek.startDate).toLocaleDateString()}
                    </span>
                  </div>
                  ...
                  <div className="flex items-center text-gray-600">
                    ...
                    <span>
                      <strong>End:</strong> {new Date(trek.endDate).toLocaleDateString()}
                    </span>
                  </div>

                  <div className="pt-4 border-t border-gray-100">
                    <h4 className="font-semibold text-gray-800 mb-2">Description:</h4>
                    <p className="text-gray-600 text-sm whitespace-pre-line">{stripHtmlTags(trek.description)}</p>
                  </div>

                  <div className="pt-4 border-t border-gray-100">
                    <h4 className="font-semibold text-gray-800 mb-2">Highlights:</h4>
                    <p className="text-gray-600 text-sm whitespace-pre-line">{stripHtmlTags(trek.highlights)}</p>
                  </div>
                  ...
                  <div className="pt-4 border-t border-gray-100">
                    ...
                    <div className="grid grid-cols-1 gap-2">
                      {trek.cityPricing.map((cp) => (
                        <div key={cp.city} className="flex justify-between">
            ...
            {/* Booking Form */}
            <div className="bg-white rounded-3xl shadow-xl p-8 border border-gray-100 relative overflow-hidden">
              <div className="absolute top-0 left-0 w-32 h-32 bg-gradient-to-br from-sky-100 to-transparent rounded-full -translate-y-16 -translate-x-16"></div>
                ...
                <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
                  ...
                  <div className="group">
                    ...
                    <div className="relative">
                      <input
                        ...
                        required
                        className="w-full border-2 border-gray-200 p-4 rounded-xl focus:border-sky-500 focus:ring-2 focus:ring-sky-200 transition-all duration-300 placeholder-gray-400"
                      />
                      <div className="absolute right-4 top-1/2 transform -translate-y-1/2">
                        <svg className="w-5 h-5 text-gray-400 group-focus-within:text-sky-500 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div className="group">
                    ...
                    <div className="relative">
                      <input
                        name="phone"
                        placeholder="Enter your phone 10 number["
                  ...
                  <div className="group">
                    ...
                    <div className="relative">
                      <select
                        ...
                        onChange={handleChange}
                        required
                        className="w-full border-2 border-gray-200 p-4 rounded-xl focus:border-sky-500 focus:ring-2 focus:ring-sky-200 transition-all duration-300 appearance-none bg-white"
                      >
                  ...
                  {/* Price Display */}
                  <div className="bg-gradient-to-r from-sky-50 to-sky-100 p-6 rounded-2xl border border-sky-200">
                    <div className="flex justify-between items-center">
                      <div>
                        <p className="text-sm text-gray-600 mb-1">Total Amount</p>
                        <p className="text-3xl font-bold text-sky-600">₹{finalPrice}</p>
                      </div>
                      <div className="text-right">
                        ...
                        {formData.city && (
                          <p className="text-sm text-gray-600">from {formData.city}</p>
                        )}
                      </div>
                    </div>
                  </div>
                  ...
                  <button
                    ...
                    className="w-full bg-gradient-to-r from-sky-600 to-sky-700 text-white p-4 rounded-xl hover:from-sky-700 hover:to-sky-800 disabled:from-gray-400 disabled:to-gray-500 disabled:cursor-not-allowed transition-all duration-300 transform hover:scale-105 hover:shadow-xl disabled:hover:scale-100 disabled:hover:shadow-none flex items-center justify-center space-x-3 font-semibold text-lg"
                  >
                    {bookingProcessing ? (
                      <>
          ...
          <div className="mt-12 bg-white rounded-3xl shadow-xl p-8 border border-gray-100">
            <h3 className="text-2xl font-bold text-gray-800 mb-6 text-center">Why Book With Us?</h3>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center group">
                <div className="w-16 h-16 bg-gradient-to-br from-sky-100 to-sky-200 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300">
                  <svg className="w-8 h-8 text-sky-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                  </svg>
                </div>
                <h4 className="text-lg font-semibold text-gray-800 mb-2">100% Safe & Secure</h4>
                <p className="text-gray-600 text-sm">Your bookings and payments are completely secure with industry-standard encryption.</p>
              </div>
              ...
              <div className="text-center group">
                ...
                <h4 className="text-lg font-semibold text-gray-800 mb-2">Expert Guides</h4>
                <p className="text-gray-600 text-sm">Professional and experienced trek leaders ensure your safety and amazing experience.</p>
              </div>
              ...
              <div className="text-center group">
                ...
                <p className="text-gray-600 text-sm">Round-the-clock customer support for any queries or assistance you need.</p>
              </div>
            </div>
          </div>
          ...
          <div className="mt-8 text-center">
            ...
            <div className="flex justify-center items-center space-x-6 opacity-70">
              ...
              <div className="text-2xl font-bold text-red-600">MasterCard</div>
              <div className="text-2xl font-bold text-orange-600">RuPay</div>
              <div className="text-lg font-semibold text-purple-600">UPI</div>
              <div className="text-lg font-semibold text-green-600">Net Banking</div>
            </div>
          </div>
        </div>
      </div>
