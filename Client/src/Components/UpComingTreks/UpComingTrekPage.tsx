...
const UpComingTrekPage: React.FC = () => {
  ...
  const fetchTreks = async () => {
    try {
      ...
      if (data.success && Array.isArray(data.data)) {
        setTreks(data.data);
        toast.success("Treks loaded successfully!", {
          position: "top-right",
          autoClose: 1000,
        });
      } else {
      ...
      const errorMsg = err instanceof Error ? err.message : "Failed to fetch treks";
      setError(errorMsg);
  ...
  // Function to clean Quill-generated HTML
  const cleanQuillContent = (html: string) => {
    if (!html) return "";
    
    // First sanitize with DOMPurify
    const sanitized = DOMPurify.sanitize(html);
    
    // Then remove any unwanted HTML tags that might come from Quill
    ...
    return (
      <div className="min-h-screen bg-white flex items-center justify-center">
        ...
        <div className="text-center max-w-md mx-auto p-8">
          ...
          <button 
            onClick={() => {
              toast.info("Refreshing page...", { position: "top-center" });
    ...
    return (
      <div className="min-h-screen bg-white flex items-center justify-center">
        ...
        <div className="text-center max-w-md mx-auto p-8">
          ...
          <button
            onClick={() => {
              toast.info("Checking for new treks...", { position: "top-center" });
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-gradient-to-br from-sky-50 via-teal-50 to-cyan-50 py-12 md:py-24 relative overflow-hidden">
        <div className="absolute inset-0">
          <div className="absolute top-10 sm:top-20 left-10 sm:left-20 w-52 sm:w-72 h-52 sm:h-72 bg-sky-200 rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-pulse"></div>
          <div className="absolute top-20 sm:top-40 right-10 sm:right-20 w-72 sm:w-96 h-72 sm:h-96 bg-cyan-200 rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-pulse" style={{animationDelay: '2s'}}></div>
          <div className="absolute -bottom-10 sm:-bottom-20 left-1/2 transform -translate-x-1/2 w-72 sm:w-96 h-72 sm:h-96 bg-teal-200 rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-pulse" style={{animationDelay: '4s'}}></div>
        </div>
        
        <div className="container mx-auto px-4 sm:px-6 text-center relative z-10">
          <div className="inline-flex items-center px-4 py-2 bg-sky-100 text-sky-800 rounded-full text-xs sm:text-sm font-semibold mb-4 md:mb-6 border border-sky-200">
                ...
                <div className="relative overflow-hidden h-60 sm:h-72">
                  ...
                  <div className="absolute bottom-4 left-4 right-4">
                    <h2 className="text-lg sm:text-xl font-bold text-white mb-2 leading-tight">
                      <div dangerouslySetInnerHTML={{ __html: cleanQuillContent(trek.name) }} />
                    </h2>
                ...
                <div className="p-4 sm:p-6 space-y-4 sm:space-y-5">
                  ...
                  <div className="grid grid-cols-2 gap-3 sm:gap-4">
                    ...
                    <div className="flex items-center gap-2 text-xs sm:text-sm text-gray-600">
                      ...
                      <div>
                        <div className="text-[10px] sm:text-xs text-gray-400 uppercase tracking-wide">Dates</div>
                  ...
                  {trek.highlights && (
                    <div className="bg-gradient-to-r from-sky-50 to-teal-50 p-3 sm:p-4 rounded-xl border border-sky-100">
                      ...
                      <div
                        className="text-xs sm:text-sm text-sky-700 max-w-none"
                        dangerouslySetInnerHTML={{ __html: cleanQuillContent(trek.highlights) }}
                      />
                    </div>
                  )}
      ...
      <div className="bg-gray-50 py-12 md:py-16">
        <div className="container mx-auto px-4 sm:px-6 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4 sm:gap-6 text-xs sm:text-sm text-gray-500">
            <div className="flex items-center">
              <svg className="w-4 h-4 sm:w-5 sm:h-5 mr-2 text-sky-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" />
              </svg>
              100% Safe & Secure
            </div>
